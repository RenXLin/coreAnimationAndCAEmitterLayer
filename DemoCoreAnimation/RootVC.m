...
-(void)doCALayerKeyFrameAnimation
{
    ...
    animation.autoreverses = YES; //返回初始状态：即方向执行动画：
    [box.layer addAnimation:animation forKey:@"backgroundColor"];
}
...
-(void)doBase3DtransformGroupAnimation
{
    ...
    CABasicAnimation *flip = [CABasicAnimation animationWithKeyPath:@"transform.rotation.z"];
...
-(void)do3DtransformAnimation
{
    ...
    box.layer.anchorPoint = CGPointMake(0.5, 0.5);
